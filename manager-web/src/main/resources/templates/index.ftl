        ...
        $(document).ready(function () {
            BJUI.init({
                ...
                pageInfo: {
                    total: 'dwz_total_',
                    pageCurrent: 'dwz_p_',
                    pageSize: 'dwz_page_size_',
                    orderField: 'dwz_order_field_',
                    orderDirection: 'dwz_order_direction_'
                }, //[可选]分页参数
...
<!--[if lte IE 7]>
<div id="errorie">
    <div>您还在使用老掉牙的IE，正常使用系统前请升级您的浏览器到 IE8以上版本
        ...
        <nav id="bjui-navbar-collapse">
            <ul class="bjui-navbar-right">
                ...
                <li class="dropdown" style="margin: 0 10px;">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="切换皮肤">
                        <i class="fa fa-tree"></i>切换皮肤
                    </a>
